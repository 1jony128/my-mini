          ...
          <div className="flex items-center justify-between">
            ...
            >
              <motion.button
                ...
                className="p-2 rounded-lg bg-background hover:bg-muted transition-colors text-foreground"
              >
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-foreground">Тема</h2>
          </div>
...
// Экспортируем с отключенным SSR
